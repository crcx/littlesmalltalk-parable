...
static int 
binaryPrims(number, firstarg, secondarg) 
  int             number;
...

{
  ...
  case 9:			/* duplicate a block, adding a new context to
				 * it */
...
static int 
trinaryPrims(number, firstarg, secondarg, thirdarg) 
  int             number;
...
static object 
intBinary(number, firstarg, secondarg) 
...
static object 
floatBinary(number, first, second) 
  int             number;
